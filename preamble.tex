...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Added by dfornika
%% mchem: Handles molecular formulae
\usepackage[version=3]{mhchem}

%% textcomp: to use \textdegree char
\usepackage{textcomp}
\usepackage{rotating}
\usepackage{subfig}
\usepackage{paralist}
...
\title{Mitochondrial Genetics and Healthy Aging}
%\subtitle{If you want a subtitle}

\author{Daniel Fornika}
\previousdegree{Molecular Biology and Biochemistry, Simon Fraser University, 2006}
...
%% files
\hypersetup{
  pdftitle={Master's Thesis: Mitochondrial Aging  (DRAFT: \today)},
  pdfauthor={Daniel Fornika},
  pdfkeywords={genetics, mitochondria, aging}
}
